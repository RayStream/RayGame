 ...
 */
+ (UIBezierPath *)rgui_bezierPathWithRoundedRect:(CGRect)rect cornerRadiusArray:(NSArray<NSNumber *> *)cornerRadius lineWidth:(CGFloat)lineWidth;

+ (UIBezierPath *)pathFromImage:(UIImage *)image size:(CGSize)size;
@end
