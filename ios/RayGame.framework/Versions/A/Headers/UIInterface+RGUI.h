...
//  RGUIKit
//
//  Created by RGUI Team on 2018/12/20.
//
...
@interface RGUIHelper (RGUI_Interface)
 ...
 *  @see [RGUIConfiguration automaticallyRotateDeviceOrientation]
 */
 ...
 *  @see [RGUIHelper rotateToDeviceOrientation]
 */
