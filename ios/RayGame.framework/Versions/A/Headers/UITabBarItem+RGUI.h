 ...
 */
@property(nonatomic, copy, nullable) void (^rgui_doubleTapBlock)(UITabBarItem *tabBarItem, NSInteger index);

/**
 * 获取一个UITabBarItem内显示图标的UIImageView，如果找不到则返回nil
 */
- (nullable UIImageView *)rgui_imageView;
+ (nullable UIImageView *)rgui_imageViewInTabBarButton:(nullable UIView *)tabBarButton;
