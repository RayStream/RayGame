...
//  rgui
//
//  Created by RGUI Team on 14-6-23.
//

#ifndef RGUICommonDefines_h
#define RGUICommonDefines_h

#import <UIKit/UIKit.h>
#import "RGUIHelper.h"
#import "NSString+RGUI.h"
...
#define BeginIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.rgui_shouldIgnoreUIKVCAccessProhibited = YES;
#define EndIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.rgui_shouldIgnoreUIKVCAccessProhibited = NO;

#pragma mark - 变量-设备相关

/// 设备类型
#define IS_IPAD [RGUIHelper isIPad]
#define IS_IPOD [RGUIHelper isIPod]
#define IS_IPHONE [RGUIHelper isIPhone]
#define IS_SIMULATOR [RGUIHelper isSimulator]
#define IS_MAC [RGUIHelper isMac]

/// 操作系统版本号，只获取第二级的版本号，例如 10.3.1 只会得到 10.3
#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] doubleValue])

/// 数字形式的操作系统版本号，可直接用于大小比较；如 110205 代表 11.2.5 版本；根据 iOS 规范，版本号最多可能有3位
#define IOS_VERSION_NUMBER [RGUIHelper numbericOSVersion]
...
#define APPLICATION_WIDTH [RGUIHelper applicationSize].width

/// 在 iPad 分屏模式下等于 app 实际运行宽度，否则等同于 DEVICE_HEIGHT
#define APPLICATION_HEIGHT [RGUIHelper applicationSize].height

/// 是否全面屏设备
#define IS_NOTCHED_SCREEN [RGUIHelper isNotchedScreen]
/// iPhone 12 Pro Max
#define IS_67INCH_SCREEN [RGUIHelper is67InchScreen]
/// iPhone XS Max
#define IS_65INCH_SCREEN [RGUIHelper is65InchScreen]
/// iPhone 12 / 12 Pro
#define IS_61INCH_SCREEN_AND_IPHONE12 [RGUIHelper is61InchScreenAndiPhone12]
/// iPhone XR
#define IS_61INCH_SCREEN [RGUIHelper is61InchScreen]
/// iPhone X/XS
#define IS_58INCH_SCREEN [RGUIHelper is58InchScreen]
/// iPhone 6/7/8 Plus
#define IS_55INCH_SCREEN [RGUIHelper is55InchScreen]
/// iPhone 12 mini
#define IS_54INCH_SCREEN [RGUIHelper is54InchScreen]
/// iPhone 6/7/8
#define IS_47INCH_SCREEN [RGUIHelper is47InchScreen]
/// iPhone 5/5S/SE
#define IS_40INCH_SCREEN [RGUIHelper is40InchScreen]
/// iPhone 4/4S
#define IS_35INCH_SCREEN [RGUIHelper is35InchScreen]
/// iPhone 4/4S/5/5S/SE
...
#define IS_ZOOMEDMODE [RGUIHelper isZoomedMode]

#pragma mark - 变量-布局相关

/// 获取一个像素
#define PixelOne [RGUIHelper pixelOne]
...
#define StatusBarHeightConstant (UIApplication.sharedApplication.statusBarHidden ? (IS_IPAD ? (IS_NOTCHED_SCREEN ? 24 : 20) : PreferredValueForNotchedDevice(IS_LANDSCAPE ? 0 : ([[RGUIHelper deviceModel] isEqualToString:@"iPhone12,1"] ? 48 : (IS_61INCH_SCREEN_AND_IPHONE12 || IS_67INCH_SCREEN ? 47 : 44)), 20)) : UIApplication.sharedApplication.statusBarFrame.size.height)
...
/// @warn 如果是用于 viewController，请使用 UIViewController(RGUI) rgui_navigationBarMaxYInViewCoordinator 代替
...
#define SafeAreaInsetsConstantForDeviceWithNotch [RGUIHelper safeAreaInsetsForDeviceWithNotch]

/// 将所有屏幕按照宽松/紧凑分类，其中 iPad、iPhone XS Max/XR/Plus 均为宽松屏幕，但开启了放大模式的设备均会视为紧凑屏幕
#define PreferredValueForVisualDevice(_regular, _compact) ([RGUIHelper isRegularScreen] ? _regular : _compact)
...
#define PreferredValueForInterfaceIdiom(_phone, _pad) (APPLICATION_WIDTH / APPLICATION_HEIGHT <= RGUIHelper.screenSizeFor35Inch.width / RGUIHelper.screenSizeFor35Inch.height ? _phone : _pad)

/// 区分全面屏和非全面屏
#define PreferredValueForNotchedDevice(_notchedDevice, _otherDevice) ([RGUIHelper isNotchedScreen] ? _notchedDevice : _otherDevice)
...
#define IPAD_SIMILAR_SCREEN_WIDTH [RGUIHelper preferredLayoutAsSimilarScreenWidthForIPad]

#define _40INCH_WIDTH [RGUIHelper screenSizeFor40Inch].width
#define _58INCH_WIDTH [RGUIHelper screenSizeFor58Inch].width
#define _65INCH_WIDTH [RGUIHelper screenSizeFor65Inch].width
...
/// 字体相关的宏，用于快速创建一个字体对象，更多创建宏可查看 UIFont+RGUI.h
...
/// UIColor 相关的宏，用于快速创建一个 UIColor 对象，更多创建的宏可查看 UIColor+RGUI.h
...
#define RGUIViewAnimationOptionsCurveOut (7<<16)
#define RGUIViewAnimationOptionsCurveIn (8<<16)
...
#define RGUIStatusBarStyleDarkContent [RGUIHelper statusBarStyleDarkContent]
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.rgui_capitalizedString];
 ...
 *  issue: https://github.com/Tencent/RGUI_iOS/issues/203
 */
CG_INLINE CGFloat
...
CGFloatToFixed(CGFloat value, NSUInteger precision) {
    ...
    CGFloat result = [NSDecimalNumber decimalNumberWithString:toString].doubleValue;
    #else
...
CG_INLINE BOOL
CGPointInCircleRect(CGPoint point, CGRect rect) {
...
CG_INLINE CGPoint
CGPointCalcCircleCoordinate(CGPoint center, CGFloat angle, CGFloat radius) {
