...
#define KBDEXT (uint16_t)0x0100
#define KBDMULTIVK (uint16_t)0x0200
#define KBDSPECIAL (uint16_t)0x0400
#define KBDNUMPAD (uint16_t)0x0800
#define KBDUNICODE (uint16_t)0x1000
#define KBDINJECTEDVK (uint16_t)0x2000
#define KBDMAPPEDVK (uint16_t)0x4000
#define KBDBREAK (uint16_t)0x8000
